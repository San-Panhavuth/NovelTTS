...
// Server component wrapper to read searchParams
...
function LoginClient({ message }: { message?: string }) {
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 px-4 dark:bg-zinc-950">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold tracking-tight">NovelTTS</h1>
          <p className="mt-1 text-sm text-zinc-500">Turn novels into audiobooks</p>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <form action={signInWithGoogle}>
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-200 px-4 py-2.5 text-sm font-medium hover:bg-zinc-50 dark:border-zinc-700 dark:hover:bg-zinc-800"
            >
              <GoogleIcon />
          ...
          {/* Tab switcher */}
          <div className="mb-5 grid grid-cols-2 rounded-lg bg-zinc-100 p-1 dark:bg-zinc-800">
            <button
              type="button"
          ...
          {tab === "signin" ? (
            <form action={signInWithPassword} className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
              >
                Sign in
              </button>
            </form>
